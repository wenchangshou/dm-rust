<template>
    <div class="mqtt-simulator-list">
        ...
        <!-- 详情对话框 -->
        <el-dialog v-model="showDetailDialog" :title="selectedSimulator?.name || 'MQTT 详情'" width="800px">
            <MqttSimulatorDetail v-if="selectedSimulator" :simulator="selectedSimulator" @refresh="fetchSimulators" />
        </el-dialog>
    </div>
</template>
...
import { Plus, VideoPlay, VideoPause, View, Delete } from '@element-plus/icons-vue'
...
import MqttSimulatorDetail from './MqttSimulatorDetail.vue'
...
const selectedSimulator = ref<MqttSimulatorInfo | null>(null)
